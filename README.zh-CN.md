...
<p align="center">
  <a href="https://github.com/ScotteLiu/Inkstill/releases"><img src="https://img.shields.io/badge/下载-Windows_x64-1f6f5f?style=for-the-badge&logo=windows" alt="下载 Inkstill Windows 版"></a>
</p>
...
[Releases 页面](https://github.com/ScotteLiu/Inkstill/releases)提供：

- `Inkstill-1.1.0 Setup.exe`：Windows x64 单用户安装版。
- `Inkstill-win32-x64-1.1.0.zip`：免安装版，解压后运行 `Inkstill.exe`。
- `SHA256SUMS.txt`：用于验证两个下载文件的校验码。
